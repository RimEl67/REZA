            ...
            <div className="p-10">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={onConfirm}
                  disabled={loading}
                  className="flex-1 px-6 py-3 bg-gray-900 hover:bg-gray-700 text-white text-sm font-light transition-all rounded-full disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
