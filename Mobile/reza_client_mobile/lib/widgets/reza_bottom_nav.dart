        ...
        child: SizedBox(
          ...
          child: Row(
            ...
            children: [
              ...
              _NavItem(icon: Icons.people_outline_rounded, label: 'Proches', index: 3, currentIndex: currentIndex, onTap: onTap),
              _NavItem(icon: Icons.person_rounded, label: 'Profil', index: 4, currentIndex: currentIndex, onTap: onTap),
            ],
          ),
        ),
      ),
