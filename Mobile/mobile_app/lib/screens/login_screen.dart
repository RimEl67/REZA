...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  // Step 0 = enter email, Step 1 = enter password, Step 2 = sign up form
  int _step = 0;
        ...
        if (_step == 0) ...[
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              onPressed: () => _showError('Connexion Google en cours...'),
